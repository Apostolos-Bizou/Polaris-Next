...
const DUMMY_CLIENTS: Client[] = [
  { client_id: 'CLI-2026-0001', parent_client_id: null, client_type: 'parent', client_name: 'DIANA SHIPPING SERVICES SA', status: 'active' },
  { client_id: 'CLI-2026-0002', parent_client_id: 'CLI-2026-0001', client_type: 'subsidiary', client_name: 'DIANA GOLD', status: 'active' },
  { client_id: 'CLI-2026-0003', parent_client_id: 'CLI-2026-0001', client_type: 'subsidiary', client_name: 'DIANA PLATINUM', status: 'active' },
  { client_id: 'CLI-2026-0004', parent_client_id: 'CLI-2026-0001', client_type: 'subsidiary', client_name: 'DIANA MARINERS INC', status: 'active' },
  { client_id: 'CLI-2026-0005', parent_client_id: null, client_type: 'parent', client_name: 'CENTROFIN', status: 'active' },
  { client_id: 'CLI-2026-0006', parent_client_id: 'CLI-2026-0005', client_type: 'subsidiary', client_name: 'CENTROFIN GOLD', status: 'active' },
  { client_id: 'CLI-2026-0007', parent_client_id: 'CLI-2026-0005', client_type: 'subsidiary', client_name: 'CENTROFIN PLATINUM', status: 'active' },
  { client_id: 'CLI-2026-0008', parent_client_id: 'CLI-2026-0005', client_type: 'subsidiary', client_name: 'CENTROFIN SILVER', status: 'active' },
  { client_id: 'CLI-2026-0009', parent_client_id: 'CLI-2026-0005', client_type: 'subsidiary', client_name: 'CENTROFIN MARINE TRUST GOLD', status: 'active' },
  { client_id: 'CLI-2026-0010', parent_client_id: 'CLI-2026-0005', client_type: 'subsidiary', client_name: 'CENTROFIN MARINE TRUST PLATINUN', status: 'active' },
  { client_id: 'CLI-2026-0011', parent_client_id: 'CLI-2026-0005', client_type: 'subsidiary', client_name: 'CENTROFIN MARINE TRUST SILVER', status: 'active' },
  { client_id: 'CLI-2026-0012', parent_client_id: 'CLI-2026-0005', client_type: 'subsidiary', client_name: 'CENTROFIN TRUST BULKERS GOLD', status: 'active' },
  { client_id: 'CLI-2026-0013', parent_client_id: 'CLI-2026-0005', client_type: 'subsidiary', client_name: 'CENTROFIN TRUST BULKERS PLATINUN', status: 'active' },
  { client_id: 'CLI-2026-0014', parent_client_id: 'CLI-2026-0005', client_type: 'subsidiary', client_name: 'CENTROFIN TRUST BULKERS SILVER', status: 'active' },
  { client_id: 'CLI-2026-0015', parent_client_id: null, client_type: 'parent', client_name: 'ASTRA SHIPMANAGEMENT INC', status: 'active' },
  { client_id: 'CLI-2026-0016', parent_client_id: 'CLI-2026-0015', client_type: 'subsidiary', client_name: 'ASTRA SHIPMANAGEMENT GOLD', status: 'active' },
  { client_id: 'CLI-2026-0017', parent_client_id: 'CLI-2026-0015', client_type: 'subsidiary', client_name: 'ASTRA TANKERS GOLD', status: 'active' },
  { client_id: 'CLI-2026-0018', parent_client_id: null, client_type: 'parent', client_name: 'AIMS ADELE SHIPHOLDING LTD', status: 'active' },
  { client_id: 'CLI-2026-0019', parent_client_id: 'CLI-2026-0018', client_type: 'subsidiary', client_name: 'AIMS GOLD', status: 'active' },
  { client_id: 'CLI-2026-0020', parent_client_id: null, client_type: 'parent', client_name: 'ANOSIS MARITIME SA', status: 'active' },
  { client_id: 'CLI-2026-0021', parent_client_id: 'CLI-2026-0020', client_type: 'subsidiary', client_name: 'ANOSIS PLATINUM', status: 'active' },
  { client_id: 'CLI-2026-0022', parent_client_id: null, client_type: 'parent', client_name: 'CROSSWORLD MARINE SERVICES INC', status: 'active' },
  { client_id: 'CLI-2026-0023', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'CROSSWORLD STAF&FAM GOLD', status: 'active' },
  { client_id: 'CLI-2026-0024', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'CROSSWORLD STAF&FAM PLATINUN', status: 'active' },
  { client_id: 'CLI-2026-0025', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'BOURBON GOLD CW', status: 'active' },
  { client_id: 'CLI-2026-0026', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'BOURBON PLATINUN CW', status: 'active' },
  { client_id: 'CLI-2026-0027', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'CASSIOPEIA GOLD CW', status: 'active' },
  { client_id: 'CLI-2026-0028', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'CASSIOPEIA PLATINUM CW', status: 'active' },
  { client_id: 'CLI-2026-0029', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'PIONEER CW', status: 'active' },
  { client_id: 'CLI-2026-0030', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'VERITAS GOLD CW', status: 'active' },
  { client_id: 'CLI-2026-0031', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'VARSHIP GOLD CW', status: 'active' },
  { client_id: 'CLI-2026-0032', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'POLARIS GOLD CW', status: 'active' },
  { client_id: 'CLI-2026-0033', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'POLARIS PLATINUM CW', status: 'active' },
  { client_id: 'CLI-2026-0034', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'CROSSWORLD KADETS', status: 'active' },
  { client_id: 'CLI-2026-0035', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'CROSSWORLD PROMO GOLD', status: 'active' },
  { client_id: 'CLI-2026-0036', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'CROSSWORLD SPECIAL PROGRAM', status: 'active' },
  { client_id: 'CLI-2026-0037', parent_client_id: 'CLI-2026-0022', client_type: 'subsidiary', client_name: 'UNION MARINE GOLD CW', status: 'active' },
  { client_id: 'CLI-2026-0038', parent_client_id: null, client_type: 'parent', client_name: 'EFNAV COMPANY LIMITED', status: 'active' },
  { client_id: 'CLI-2026-0039', parent_client_id: 'CLI-2026-0038', client_type: 'subsidiary', client_name: 'EFNAV GOLD', status: 'active' },
  { client_id: 'CLI-2026-0040', parent_client_id: null, client_type: 'parent', client_name: 'GOLDEN UNION SHIPPING CO SA', status: 'active' },
  { client_id: 'CLI-2026-0041', parent_client_id: 'CLI-2026-0040', client_type: 'subsidiary', client_name: 'GOLDEN UNION SHIPPING GOLD', status: 'active' },
  { client_id: 'CLI-2026-0042', parent_client_id: 'CLI-2026-0040', client_type: 'subsidiary', client_name: 'GOLDEN UNION SHIPPING PALTINUN', status: 'active' },
  { client_id: 'CLI-2026-0043', parent_client_id: 'CLI-2026-0040', client_type: 'subsidiary', client_name: 'GOLDEN UNION WORLD MANAGEMENT GOLD', status: 'active' },
  { client_id: 'CLI-2026-0044', parent_client_id: 'CLI-2026-0040', client_type: 'subsidiary', client_name: 'GOLDEN UNION ENTERPRISES GOLD', status: 'active' },
  { client_id: 'CLI-2026-0045', parent_client_id: null, client_type: 'parent', client_name: 'HEALTHPLUS DIAGNOSTIC CLINIC INC', status: 'active' },
  { client_id: 'CLI-2026-0046', parent_client_id: 'CLI-2026-0045', client_type: 'subsidiary', client_name: 'HEALTHPLUS GOLD', status: 'active' },
  { client_id: 'CLI-2026-0047', parent_client_id: null, client_type: 'parent', client_name: 'OMICRON SHIP MANAGEMENT INC', status: 'active' },
  { client_id: 'CLI-2026-0048', parent_client_id: 'CLI-2026-0047', client_type: 'subsidiary', client_name: 'OMICRON GOLD', status: 'active' },
  { client_id: 'CLI-2026-0049', parent_client_id: null, client_type: 'parent', client_name: 'KYKLADES MARITIME CORPORATION', status: 'active' },
  { client_id: 'CLI-2026-0050', parent_client_id: 'CLI-2026-0049', client_type: 'subsidiary', client_name: 'KYKLADES PLATINUM', status: 'active' },
  { client_id: 'CLI-2026-0051', parent_client_id: null, client_type: 'parent', client_name: 'MINOA MARINE LIMITED', status: 'active' },
  { client_id: 'CLI-2026-0052', parent_client_id: 'CLI-2026-0051', client_type: 'subsidiary', client_name: 'MINOA GOLD', status: 'active' },
  { client_id: 'CLI-2026-0053', parent_client_id: null, client_type: 'parent', client_name: 'LEADER MARINE', status: 'active' },
  { client_id: 'CLI-2026-0054', parent_client_id: 'CLI-2026-0053', client_type: 'subsidiary', client_name: 'LEADER MARINE AQUILA BULKERS INC GOLD', status: 'active' },
  { client_id: 'CLI-2026-0055', parent_client_id: 'CLI-2026-0053', client_type: 'subsidiary', client_name: 'LEADER MARINE FALCON SHIPHOLDING INC GOLD', status: 'active' },
  { client_id: 'CLI-2026-0056', parent_client_id: 'CLI-2026-0053', client_type: 'subsidiary', client_name: 'LEADER MARINE IONIAN UNITED SHIPHOLDING INC GOLD', status: 'active' },
  { client_id: 'CLI-2026-0057', parent_client_id: 'CLI-2026-0053', client_type: 'subsidiary', client_name: 'LEADER MARINE LEADER BULKERS INC GOLD', status: 'active' },
  { client_id: 'CLI-2026-0058', parent_client_id: 'CLI-2026-0053', client_type: 'subsidiary', client_name: 'LEADER MARINE MOONSHINE BULKERS INC GOLD', status: 'active' },
  { client_id: 'CLI-2026-0059', parent_client_id: 'CLI-2026-0053', client_type: 'subsidiary', client_name: 'LEADER MARINE NOMADE HOLDING LTD GOLD', status: 'active' },
  { client_id: 'CLI-2026-0060', parent_client_id: 'CLI-2026-0053', client_type: 'subsidiary', client_name: 'LEADER MARINE PEGASUS BULKERS INC GOLD', status: 'active' },
  { client_id: 'CLI-2026-0061', parent_client_id: null, client_type: 'parent', client_name: 'IONIC', status: 'active' },
  { client_id: 'CLI-2026-0062', parent_client_id: 'CLI-2026-0061', client_type: 'subsidiary', client_name: 'IONIC GOLD', status: 'active' },
  { client_id: 'CLI-2026-0063', parent_client_id: 'CLI-2026-0061', client_type: 'subsidiary', client_name: 'IONIC PLATINUM', status: 'active' },
];
